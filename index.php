...
<body>
    ...
    <header class="sticky-top">
        <nav class="navbar navbar-expand-lg navbar-success bg-success">
            <div class="container">
                ...
                <!-- BRAND (KIRI SENDIRI) -->
                <a class="navbar-brand fw-bold" href="#">KonveksiKu</a>
                ...
                <div id="heroCarousel" class="carousel slide carousel-fade rounded shadow overflow-hidden"
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption d-flex flex-column justify-content-center h-100 text-success" style="text-shadow: 1px 1px 0 #fff, -1px -1px 0 #000;">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <img src="1.jpeg" class="card-img-top" alt="Kaos Custom">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <img src="2.jpeg" class="card-img-top" alt="Hoodie Custom">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <img src="3.jpeg" class="card-img-top" alt="Kemeja Seragam">
                            <div class="card-body">
    ...
    <footer class="bg-secondary text-white text-center py-3">
        <div class="container">
            <small>&copy; 2026 KonveksiKu. All Rights Reserved.</small>
        </div>
    </footer>
